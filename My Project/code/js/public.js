...
//4、获取这种格式的日期：2018年X月X日 00:00:00 星期X
...
//8、跨浏览器兼容ie8及以下浏览器获取事件对象的button属性
...
//10、跨浏览器兼容ie8及以下阻止默认行为
function preventDefault(e) {
	return e.preventDefault ? e.preventDefault() : e.returnValue = false;
}

//11、跨浏览器兼容ie8及以下的事件监听
